...
st.write("LinkedIn: [/mjohnyasar/](https://www.linkedin.com/in/mjohnyasar/)")
st.write("GitHub: [/mjohnyasar](https://github.com/mjohnyasar)")
st.write("Kaggle: [/muharremyasar](https://www.kaggle.com/muharremyasar)")
st.write("Stackoverflow: [/m-john](https://stackoverflow.com/users/16801544/m-john)")
